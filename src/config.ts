...
export const siteConfig: SiteConfig = {
	title: "落叶Rakuyou's Labyrinth",
	subtitle: "My Personal Library",
	siteURL: "https://mizuki-woad.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-12-10", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	font: {
		...
		cjkFont: {
			...
			fontFamily: "霞鹜文楷",
			fontWeight: "500",
			localFonts: ["LXGWWenKaiMonoScreen.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/SilverStr1ng",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/9201370",
					external: true,
	...
	tips: {
		...
		idleTips: {
			...
			message: {
				...
				morning: ["准备好开始新的一天了吗？", "早安，又是充满活力的一天。"],
